...
```shell
# Build
docker build . -f flavors/biotope/naavre-cell-runtime.Dockerfile --build-arg CONDA_ENV_FILE=flavors/biotope/environment.yaml -t tmp-cell-runtime
docker build . -f docker/naavre-cell-build.Dockerfile --build-arg CONDA_ENV_FILE=flavors/biotope/environment.yaml -t tmp-cell-build
docker build . -f flavors/biotope/naavre-jupyter.Dockerfile --build-arg NAAVRE_VERSION=v2.4.3 --build-arg CONDA_ENV_FILE=flavors/biotope/environment.yaml -t tmp-jupyter
